...
- Extreme value analysis of annual minimum drought severity
...
5. **Annual minimum series extraction (AMS)**  
   Extract annual minimum drought severity time series.
...
| 04_AMS_drought.ipynb | Annual minimum drought severity extraction |
